        ...
        <div class="card shadow-lg h-100">
            <div class="card-header bg-orange text-white text-center">
                <div class="row">
                    ...
                    <div class="col-md-11"><b>CUESTIONARIO EXTRALABORAL</b></div>
                </div>
            </div>
            <div class="card-body">
                <form id="cuestionario" data-tipo="3" data-campos="camposExtralaboral" data-id="cuestionario" data-controlador="cuestionariosController" action="javascript:void(0);">
