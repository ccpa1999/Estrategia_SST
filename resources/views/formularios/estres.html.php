        ...
        <div class="card shadow-lg h-100">
            <div class="card-header bg-orange text-white text-center">
                <div class="row">
                    ...
                    <div class="col-md-11"><b>CUESTIONARIO ESTRES</b></div>
                </div>
            </div>
            <div class="card-body">
                <form id="cuestionario" data-tipo="4" data-campos="camposEstres" data-id="cuestionario" data-controlador="cuestionariosController" action="javascript:void(0);">
